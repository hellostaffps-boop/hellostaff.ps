      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-foreground leading-[1.1]">
            Find the perfect
            <span className="text-accent"> staff</span> for your
            <span className="text-accent"> business</span>
          </h1>

          <p className="mt-6 text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            Hello Staff connects cafes and restaurants with skilled workers. 
            Post jobs, discover talent, and build your dream team — all in one place.
          </p>
