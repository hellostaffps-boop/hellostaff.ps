...
import { getNotifications, markNotificationRead } from "@/lib/firestoreService";
    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-2">
          {notifications.map((n) => (
            <div key={n.id}
              className={`bg-white rounded-xl border border-border p-4 cursor-pointer ${!n.is_read ? "border-s-4 border-s-accent" : ""}`}
